...
import joblib 
try:
    VECTORIZER_PATH = "hashing_vectorizer_128_ast_node_texts.joblib" 
...
class FusionModel(nn.Module):
    def __init__(self, gnn_encoder, projection_dim=128, num_classes=4):
        super().__init__()
    ...
    def forward(self, graph_data=None, input_ids=None, attention_mask=None, labels=None):
        ...
        fused_embedding = projected_graph
...
gnn = GCNForGraphEncoder(input_dim=256,
                                   hidden_dim=128, ) 
model = FusionModel(gnn_encoder=gnn, num_classes=2) 
